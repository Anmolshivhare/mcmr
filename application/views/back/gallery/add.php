                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post" action="<?php echo base_url();?>admingallery/add"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="g_cat_id">
                                                        <?php   $gallerycategory = $this->Adminmodel->select('gallerycategory','',0,'desc');
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="event_id">
                                                        <?php   $event = $this->Adminmodel->select('event','',0,'desc');
                                                         foreach($event as $viewstate) { ?>
                                                        <option value="<?php echo  $viewstate->id;?>">
