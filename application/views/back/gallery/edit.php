                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post"
                                        action="<?php echo base_url();?>admingallery/edit/<?php echo $update[0]->id?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-password-input">Gallery
                                                        Category Name</label>

                                                    <select class="form-select" name="g_cat_id">

                                                        <option value="<?php echo $update[0]->g_cat_id?>">

                                                            <?php 
                                                            $st_id =  $update[0]->g_cat_id;
                                                            $sqll= "SELECT * FROM gallerycategory WHERE id='$st_id'"; 
                                                                        $sql = $this->db->query($sqll);
                                                                        $query= $sql->result();
                                                                        if(isset($query[0]->gc_name)) {
                                                                            echo $query[0]->gc_name;
                                                                        }
                                                                    ?>

                                                        </option>

                                                        <?php   $state = $this->Adminmodel->select('gallerycategory','',0,'desc');
                                                    foreach($gallerycategory as $viewstate) { ?>
                                                        <option value="<?php echo  $viewstate->id;?>">
                                                            <?php echo  $viewstate->gc_name;?></option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-password-input">
                                                        Important Decision</label>

                                                    <select class="form-select" name="event_id">

                                                        <option value="<?php echo $update[0]->event_id?>">

                                                            <?php 
                                                            $st_id =  $update[0]->event_id;
                                                            $sqll= "SELECT * FROM `event` WHERE id='$st_id'"; 
                                                                        $sql = $this->db->query($sqll);
                                                                        $query= $sql->result();
                                                                        if(isset($query[0]->e_name)) {
                                                                            echo $query[0]->e_name;
                                                                        }
                                                                    ?>
                                                        ...
                                                        <?php   $state = $this->Adminmodel->select('event','',0,'desc');
                                                    foreach($gallerycategory as $viewstate) { ?>
                                                        <option value="<?php echo  $viewstate->id;?>">
                                                            <?php echo  $viewstate->e_name;?></option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Gallery
                                                        Title</label>

                                                    <input type="text" name="g_title" class="form-control"
                                                        value="<?php echo $update[0]->g_title?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="g_img" class="form-control"
                                                        id="formrow-email-input">
                                                    <img src="<?php echo base_url();?>upload_images/<?php echo  $update[0]->g_img;?>"
                                                        width="50">
