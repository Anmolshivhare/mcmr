        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <h4 class="mb-0">Responsibility</h4>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Responsibility</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post"
                                        action="<?php echo base_url();?>admindesignation/edit/<?php echo $update[0]->id?>"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Responsibility
                                                        Name</label>

                                                    <input type="text" name="des_name" class="form-control"
                                                        value="<?php echo $update[0]->des_name?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="des_img" class="form-control"
                                                        id="formrow-email-input">
                                                    <img src="<?php echo base_url();?>upload_images/<?php echo  $update[0]->des_img;?>"
                                                        width="50">
