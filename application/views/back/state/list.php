                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <div class="button-items">
                            ...
                            <a href="<?php echo base_url()?>adminstate/add"
        ...
        <div class="row">
            ...
            <div class="col-12">
              ...
              foreach($viewcategory as $view) { ?>
                                <tr>
                                    <td><?php echo $i;?></td>
                                    <td><?php echo $view->s_name;?></td>
                                    <td><img src="<?php echo base_url();?>upload_images/<?php echo $view->s_img;?>"
                                            width="100"> </td>
                                    <td>
...
?>
                                    ...
                                    <td><a class="btn btn-primary"
                                            href="<?php echo base_url();?>adminstate/edit/<?php echo $view->id;?>"> <i
...
function myFunction(id) {
    ...
    if (r == true)
        ...
        window.location = url + "/adminstate/delete/" + id;
