                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <div class="button-items">
                            ...
                            <a href="<?php echo base_url()?>admindesignation/add"
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive   nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i;?></td>
                                    <td><?php echo $view->des_name;?></td>
                                    <td><img src="<?php echo base_url();?>upload_images/<?php echo $view->des_img;?>"
                                            width="100"> </td>
                                    <td>
                                    ...
                                    <td><a class="btn btn-primary"
                                            href="<?php echo base_url();?>admindesignation/edit/<?php echo $view->id;?>"><i
...
function myFunction(id) {
    ...
    if (r == true)
        ...
        window.location = url + "/admindesignation/delete/" + id;
