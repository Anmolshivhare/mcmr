<div class="page-content">
 ...
 <form method="post" action="<?php echo base_url();?>admindesignation/add" enctype="multipart/form-data">
...
<div class="mb-3">
    ...
    <label class="form-label" for="formrow-email-input">Designation Name</label>

    <input type="text" name="des_name" class="form-control"   id="formrow-email-input">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="file" name="des_img" class="form-control"   id="formrow-email-input">
