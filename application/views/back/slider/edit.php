                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post"
                                        action="<?php echo base_url();?>adminslider/edit/<?php echo $update[0]->id?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Hading 1
                                                        Name</label>

                                                    <textarea type="text" name="slide_heading" class="form-control"
                                                        id="formrow-email-input"
                                                        rows="1"><?php echo $update[0]->slide_heading?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Hading 2
                                                        Name</label>

                                                    <textarea type="text" name="slide_heading_2" class="form-control"
                                                        id="formrow-email-input"
                                                        rows="1"><?php echo $update[0]->slide_heading_2?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Heading 3
                                                        Name</label>

                                                    <textarea type="text" name="slide_link" class="form-control"
                                                        id="formrow-email-input"
                                                        rows="1"><?php echo $update[0]->slide_link?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="slide_img" class="form-control"
                                                        id="formrow-email-input">
                                                    <img src="<?php echo base_url();?>upload_images/<?php echo  $update[0]->slide_img;?>"
                                                        width="50">
