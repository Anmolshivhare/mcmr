                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <div class="button-items">
                            ...
                            <a href="<?php echo base_url()?>adminadvocate/add"
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                     $cit =  $view->cat_id;
                                    $citname= "SELECT * FROM `category` WHERE id='$cit'"; 
                                     $sql = $this->db->query($citname);
                                    $query= $sql->result();
                                    ...
                                    <td><?php  
                                     $cit =  $view->des_id;
                                    $citname= "SELECT * FROM `designation` WHERE id='$cit'"; 
                                     $sql = $this->db->query($citname);
                                    $query= $sql->result();
                                    ...
                                    <td><?php echo $view->adv_name;?></td>
                                    <td>
                                        <img src="<?php echo base_url();?>upload_images/<?php echo $view->adv_img;?>"
                                            width="100">
                                    </td>

                                    <td><?php echo $view->adv_phone;?></td>

                                    <td><?php echo $view->adv_email;?></td>
                                    ...
                                    <td><a class="btn btn-primary"
                                            href="<?php echo base_url();?>adminadvocate/edit/<?php echo $view->id;?>"><i
...
function myFunction(id) {
    ...
    if (r == true)
        ...
        window.location = url + "/adminadvocate/delete/" + id;
