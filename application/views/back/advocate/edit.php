                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Specialization
                                                        Name</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">Extra Responsibility
                                                         </label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="a_designation" class="form-control"
                                                        value="<?php echo $update[0]->a_designation?>"
                                                        id="formrow-email-input">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="a_workplace" class="form-control"
                                                        value="<?php echo $update[0]->a_workplace?>"
                                                        id="formrow-email-input">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="a_prectice" class="form-control"
                                                        value="<?php echo $update[0]->a_prectice?>"
                                                        id="formrow-email-input">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="adv_area" class="form-control"
                                                        value="<?php echo $update[0]->adv_area?>"
                                                        id="formrow-email-input">
