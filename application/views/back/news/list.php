                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <div class="button-items">
                            ...
                            <a href="<?php echo base_url()?>adminnews/add"
                            ...
                            <tbody>
                                ...
                                <tr>
								 ...
								 $sqll= "SELECT * FROM newscategory WHERE id='$st_id'"; 
                                    ...
                                    <td><img src="<?php echo base_url();?>upload_images/<?php echo $view->n_img;?>"
                                            width="100"> </td>
                                    <td>
                                    ...
                                    <td><a class="btn btn-primary"
                                            href="<?php echo base_url();?>adminnews/edit/<?php echo $view->id;?>"><i
...
function myFunction(id) {
    ...
    if (r == true)
        ...
        window.location = url + "/adminnews/delete/" + id;
