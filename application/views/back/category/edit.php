                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post"
                                        action="<?php echo base_url();?>admincategory/edit/<?php echo $update[0]->id?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="cat_name" class="form-control"
                                                        value="<?php echo $update[0]->cat_name?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="cat_img" class="form-control"
                                                        id="formrow-email-input">
                                                    <img src="<?php echo base_url();?>upload_images/<?php echo  $update[0]->cat_img;?>"
                                                        width="50">
