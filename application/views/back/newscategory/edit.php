                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="post"
                                        action="<?php echo base_url();?>adminnewscategory/edit/<?php echo $update[0]->id?>"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label" for="formrow-email-input">News Category
                                                        Name</label>

                                                    <input type="text" name="nc_name" class="form-control"
                                                        value="<?php echo $update[0]->nc_name?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="nc_img" class="form-control"
                                                        id="formrow-email-input">
                                                    <img src="<?php echo base_url();?>upload_images/<?php echo  $update[0]->nc_img;?>"
                                                        width="50">
