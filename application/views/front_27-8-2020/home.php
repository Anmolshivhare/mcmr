...
<div class="page-content">
    <div class="page-title page-title-large">
        <!-- <h2 data-username="Enabled!" class="greeting-text">Welcome</h2> -->
        <!-- <a href="#" data-menu="menu-main" class="bg-fade-highlight-light shadow-xl preload-img" -->
        <!-- data-src="<?php echo base_url();?>front_assets/images/avatars/5s.png"></a> -->
    </div>
    <div class="card header-card shape-rounded" data-card-height="210">
        <div class="card-overlay bg-highlight opacity-95"></div>
        <div class="card-overlay dark-mode-tint"></div>
        <div class="card-bg preload-img" data-src="<?php echo base_url();?>front_assets/images/pictures/20s.jpg"></div>
    </div>
                ...
                <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l bg-17" data-card-height="320">
                        <div class="card-bottom">
                            <h1 class="font-24 font-700">Meet Bar Association Kannauj</h1>
                            <p class="boxed-text-xl">
                                Bar Association Kannauj brings beauty and colors to your Mobile device with a stunning
                                user
                                interface to match.
                            </p>
                        </div>
                ...
                <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l bg-8" data-card-height="320">
                        <div class="card-bottom">
                            ...
                            <p class="boxed-text-xl">
                                Bar Association Kannauj is a Mobile Web App Kit, fully featured, supporting PWA and
                                Native Dark
                                Mode!
                            </p>
                        </div>
                ...
                <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l bg-14" data-card-height="320">
                        <div class="card-bottom">
                            ...
                            <p class="boxed-text-xl">
                                We build custom, premium products, that are easy to use and provide all features
                                for you!
                            </p>
                        </div>
                        <div class="card-overlay bg-gradient-fade"></div>
    ...
    <div class="content mt-0">
        <div class="row">
            <div class="col-6">
                <a href="About-Us.php"
                    class="btn btn-full btn-m rounded-s text-uppercase font-900 shadow-xl bg-highlight">About Us</a>
            </div>
            <div class="col-6">
                <a href="page-contact.php"
                    class="btn btn-full btn-border btn-m rounded-s text-uppercase font-900 shadow-l border-highlight color-highlight">Contact
                    US</a>
            </div>
        </div>
    </div>
    ...
    <div class="content mb-3 mt-0">
        <h5 class="float-start font-16 font-500">Our Members</h5>
        <a class="float-end font-12 color-highlight mt-n1" href="index-members.php">View All</a>
                ...
                <div class="splide__slide ps-3">
                    <div class="bg-theme pb-3 rounded-m shadow-l text-center overflow-hidden">
                        <div data-card-height="150" class="card mb-2 bg-29">
                            <h5 class="card-bottom color-white mb-2"><?php echo $view->adv_name; ?></h5>
                            <div class="card-overlay bg-gradient"></div>
                        </div>
                        <p class="mb-3 ps-2 pe-2 pt-2 font-12">
                            Classic, elegant and powerful.
                        </p>
                        <a href="index-members.php"
                            class="btn btn-xs bg-highlight btn-center-xs rounded-s shadow-s text-uppercase font-900">View</a>
                    </div>
                </div>
                <?php } ?>
    ...
    <!-- <div class="splide double-slider visible-slider slider-no-arrows slider-no-dots" id="double-slider-1">
                <div class="splide__track">
                    <div class="splide__list">
                        ...
                        <div class="splide__slide ps-3">
                            <div class="bg-theme rounded-m shadow-m text-center">
                                <i class="mt-4 mb-4" data-feather="smartphone" data-feather-line="1"
                                    data-feather-size="45" data-feather-color="brown-dark"
    ...
    <!-- <div class="card preload-img" data-src="<?php echo base_url();?>front_assets/images/pictures/20s.jpg">
                <div class="card-body">
                    ...
                    <div class="card card-style ms-0 me-0 bg-theme">
                        <div class="row mt-3 pt-1 mb-3">
                            <div class="col-6">
                                <i class="float-start ms-3 me-3" data-feather="globe" data-feather-line="1"
                                    data-feather-size="35" data-feather-color="blue-dark"
                                    data-feather-bg="blue-fade-light">
                                </i>
                                <h5 class="color-theme float-start font-13 font-500 line-height-s pb-3 mb-3">
                                    Mobile<br>Website</h5>
                            </div>
                            <div class="col-6">
                                <i class="float-start ms-3 me-3" data-feather="smartphone" data-feather-line="1"
                                    data-feather-size="35" data-feather-color="dark-dark"
                            ...
                            <div class="col-6">
                                <i class="float-start ms-3 me-3" data-feather="user" data-feather-line="1"
                                    data-feather-size="35" data-feather-color="brown-dark"
                                    data-feather-bg="brown-fade-light">
                                </i>
                                <h5 class="color-theme float-start font-13 font-500 line-height-s">Mobile<br>Website
                                </h5>
                            </div>
                            <div class="col-6">
                                <i class="float-start ms-3 me-3" data-feather="box" data-feather-line="1"
                                    data-feather-size="35" data-feather-color="green-dark"
    ...
    <div class="card card-style">
        <div class="content text-center">
            ...
            <p class="boxed-text-xl">
                Our products are designed to simplify the way you code a page, with focus on easy, copy and
                paste.
            </p>
        </div>
    ...
    <!-- <div class="card card-style preload-img" data-src="<?php echo base_url();?>front_assets/images/pictures/20s.jpg" data-card-height="350">
                <div class="card-center text-center">
                    <p class="line-height-xl font-19 font-300 color-white ps-3 pe-3 mb-2">
                        This is a great product! Many components that we can use, and I really appreciate the support
                        from Enabled. Very responsive and provides great solutions.
                    </p>
                    <p class="opacity-50 color-white">Envato Customer</p>
                    <a href="#"
                        class="btn btn-m rounded-s btn-border color-white border-white text-uppercase font-900">View
                        Testimonials</a>
                </div>
                <div class="card-overlay bg-highlight opacity-90"></div>
            </div> -->
    <div class="card card-style">
        <div class="content">
            ...
            <div class="clearfix"></div>
            <p class="pt-2">
                Over 30.000 people use our products, and we're always happy to see the positiv impact our
                products have had! Thank you!
            </p>
        </div>
                ...
                <div class="splide__list">
                    <div class="splide__slide">
                        <div class="text-center">
                            <img src="<?php echo base_url();?>front_assets/images/avatars/1s.png" width="55" height="55"
                    ...
                    <div class="splide__slide">
                        <div class="text-center">
                            <img src="<?php echo base_url();?>front_assets/images/avatars/2s.png" width="55" height="55"
                                class="rounded-xl shadow-l gradient-red">
                            <p>Craig</p>
                        </div>
                    </div>
                    <div class="splide__slide">
                        <div class="text-center">
                            <img src="<?php echo base_url();?>front_assets/images/avatars/1s.png" width="55" height="55"
                                class="rounded-xl shadow-l gradient-green">
                            <p>Jane</p>
                        </div>
                    </div>
                    <div class="splide__slide">
                        <div class="text-center">
                            <img src="<?php echo base_url();?>front_assets/images/avatars/2s.png" width="55" height="55"
                                class="rounded-xl shadow-l gradient-brown">
                            <p>Craig</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- <div class="card card-style mt-4 shadow-l" data-card-height="150">
                <div class="card-center ps-3 pe-3">
                    ...
                    <p class="color-white mb-0 opacity-60">
                        We're the top selling Mobile Author on Envato. We value the quality of products and efficiency
                        of our support!
                    </p>
                </div>
                <div class="card-overlay bg-highlight opacity-90"></div>
    ...
    <!-- <div class="card card-style text-center">
                <div class="content pb-2">
                    <h1>
                        <i data-feather="gift" data-feather-line="1" data-feather-size="55"
                            data-feather-color="red-dark" data-feather-bg="red-fade-light">
                        </i>
                    </h1>
                    ...
                    <a href="#"
                        class="btn btn-center-xl btn-m text-uppercase font-900 bg-highlight rounded-sm shadow-l">Buy now
                        - $25</a>
                </div>
            </div> -->

    <!-- <div class="footer" data-menu-load="menu-footer.php"></div> -->
</div>
