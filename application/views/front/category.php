    ...
    <div class="page_single layout_fullwidth_padding">
        ...
        <ul class="features_list_detailed">
            ...
            <li>
                ...
                <a href="<?php echo base_url();?>home/category_wise_member/<?php echo $view->id;?>">
                    <?php if($view->cat_img) {?>
                    <div class="feat_small_icon"><img
                            src="<?php echo base_url();?>upload_images/<?php echo $view->cat_img;?>" alt="" title="" />
                    </div>
                    <?php }
                    ...
                    <div class="feat_small_details">
                        <h5><a href="<?php echo base_url();?>home/category_wise_member/<?php echo $view->id;?>"><?php echo $view->cat_name; ?> </a></h5>
