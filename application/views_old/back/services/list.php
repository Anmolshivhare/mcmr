                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <div class="button-items">
                                            <a href="<?php echo base_url()?>adminservices/add" class="btn btn-success btn-rounded waves-effect waves-light">Add</a>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr><?php echo isset($m_title)?$m_title:'';?>
                                                ...
                                                <td><?php echo $record->title;?></td>
 												...
 												<td><?php echo ($record->feature=='1')? 'Enable':'Disabled';?></td>
												...
												<div class="button-items">
                                            <a href="<?php echo base_url()?>adminservices/edit/<?php echo $record->id ?>" class="btn btn-primary btn-rounded waves-effect waves-light"><i class="fas fa-edit"></i></a>
...
<script>
        function myFunction(id) {
            ...
            if (r==true)
                window.location = url+"/adminservices/delete/"+id;
            else
                return false;
        }
