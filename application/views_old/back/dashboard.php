                ...
                <div class="page-content">
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Gwella </a></li>
						...
						<table id="datatable-buttons" class="table table-centered table-nowrap mb-0">
										  ...
										  <a href="<?php echo base_url()?>adminproduct/edit/<?php echo $record->id ?>" class="btn btn-primary btn-rounded waves-effect waves-light"><i class="fas fa-edit"></i></a>
