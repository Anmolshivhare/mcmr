                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <a href="index.html" class="mb-5 d-block auth-logo">
                                <img src="http://localhost/mushroom/upload_images/4a9cd38fe5cb780151273f3aa4d6d72c.png" alt="" height="80" class="logo logo-dark">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4"> 
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Gwella</p>
                                </div>
                                <div class="p-2 mt-4">
